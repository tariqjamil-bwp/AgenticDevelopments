...
gemini_api_key = os.getenv("GEMINI_API_KEY")#st.sidebar.text_input("Gemini API Key", type="password")
serper_api_key = os.getenv("SERPER_API_KEY")#st.sidebar.text_input("Serper API Key", type="password")
...
if gemini_api_key and serper_api_key:
    ...
    gemini = LLM(model="gemini/gemini-2.0-flash", temperature= 0.7, api_key=gemini_api_key)
