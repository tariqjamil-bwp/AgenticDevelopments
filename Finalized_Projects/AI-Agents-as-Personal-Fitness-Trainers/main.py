...
# Utility function to get gemini openai compat API LLM
def get_openai_llm(model_name="gemini-2.0-flash"):
    print(f"Creating ChatOpenAI with model: {model_name}")
    return ChatOpenAI(model=model_name, base_url=base_url, api_key=os.getenv('GEMINI_API_KEY'))
