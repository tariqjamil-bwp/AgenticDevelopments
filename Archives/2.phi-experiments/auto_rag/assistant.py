...
from phi.storage.assistant.sqllite import SqlLiteAssistantStorage
...
def get_auto_rag_assistant(
    llm_model: str = "llama3.1-70b-8192",
    ...
    return Assistant(
        ...
        storage=None, #PgAssistantStorage(table_name="auto_rag_assistant_openai", db_url=db_url),
        knowledge_base=AssistantKnowledge(
            vector_db=PgVector2(
                db_url=db_url,
                collection="auto_rag_documents_groq",
