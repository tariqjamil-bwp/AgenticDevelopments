...
#test_input = {"messages": [HumanMessage(content="Write a report on movie Jaws")]}
test_input = {"messages": [HumanMessage(content="Write a long-form LinkedIn newsletter in professional tone, on 'AI usage in Aviation'. Make report with following ares in mind. Operations, Maintenance, Safety management, Quality assurance, route optimization, Marketing, etc. Pay special attention to airctaft operation and maintenance, as the core use case. Mention who is using AI in airctaft operations. Give links to your sources, and also verify the linkes that they actually exist.")]}
